...
selectYes.isClick = false;
addEvent(selectYes,'click',function () {
    selectYes.isClick = true;
    tipsDelClose();
});
...
for(var i =0;i<addBtn.length;i++){
    ...
    addEvent(deletes[i],'click',function () {
        ...
        animation(tipsDel,{left:(client().width/2-190),width:340,height:100});
        tipsDelClose(this);
    } );
    function tipsDelClose(obj) {
        if(selectYes.isClick){
